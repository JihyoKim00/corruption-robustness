...
from utils.imagenet200 import load_imagenet200
...
parser.add_argument('--dataset', default='cifar10', type=str, 
                    choices=['cifar10', 'cifar100', 'cub200', 'imagenet', 'imagenet200'],
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.dataset == 'cub200':
        ...
        train_loader, train_givenY, train_sampler, test_loader = load_cub200(
            input_size=input_size, partial_rate=args.partial_rate, batch_size=args.batch_size)
    elif args.dataset == 'imagenet':
        input_size = 224  # fixed as 224
        train_loader, train_givenY, train_sampler, test_loader = load_imagenet(
            input_size=input_size, partial_rate=args.partial_rate, batch_size=args.batch_size)
    elif args.dataset == 'imagenet200':
        input_size = 224  # fixed as 224
        train_loader, train_givenY, train_sampler, test_loader = load_imagenet200(
            input_size=input_size, partial_rate=args.partial_rate, batch_size=args.batch_size)
