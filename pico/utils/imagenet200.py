...
def load_imagenet200(input_size, partial_rate, batch_size):
    ...
    train_dataset = ImageNet200(root='/data/imagenet200/', train=True,
                                w_transform=weak_transform,
                                s_transform=strong_transform,
                                partial_rate=partial_rate)
    test_dataset = ImageNet200(root='/data/imagenet200/', train=False,
...
class ImageNet200(torch.utils.data.Dataset):
