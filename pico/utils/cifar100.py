...
def load_cifar100(partial_rate, batch_size, hierarchical):
    ...
    temp_train = dsets.CIFAR100(root='/data/cifar100_data/', train=True, download=True)
    data, labels = temp_train.data, torch.Tensor(temp_train.targets).long()
    # get original data and labels

    test_dataset = dsets.CIFAR100(root='/data/cifar100_data/', train=False, transform=test_transform)
